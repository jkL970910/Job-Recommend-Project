...
public class MonkeyLearnClient {
	private static final String API_KEY = "ebfe6d70c85cbe60461b2d257cde4882e18253dd";
	private static final String API_MODEL_ID = "ex_YCya9nrn";
...
//				"The NEOWISE comet has been delighting skygazers around the world this month ¨C with photographers turning their lenses upward and capturing it above landmarks across the Northern Hemisphere."
//		};
//
...
//	
	...
	public static List<List<String>> extractKeywords(String[] text) {
		...
		try {
			response = ml.extractors.extract(API_MODEL_ID, text, extraParams);//change to your model id
